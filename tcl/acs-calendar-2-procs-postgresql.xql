...
as saturday_julian,
:current_date::timestamptz - '7 days'::interval as last_week,
to_char(:current_date::timestamptz - '7 days'::interval, 'Month DD, YYYY') as last_week_pretty,
:current_date::timestamptz + '7 days'::interval as next_week,
to_char(:current_date::timestamptz + '7 days'::interval, 'Month DD, YYYY') as next_week_pretty
from     dual
</querytext>
</fullquery>
